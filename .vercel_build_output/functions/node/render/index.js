...
async function fetch2(url, options_) {
	return new Promise((resolve2, reject) => {
		...
		const send = (
			parsedURL.protocol === 'https:' ? import_node_https2.default : import_node_http2.default
		).request
		...
		request_.on('response', (response_) => {
			...
			if (codings === 'gzip' || codings === 'x-gzip') {
				body = (0, import_node_stream2.pipeline)(
					body,
					import_node_zlib2.default.createGunzip(zlibOptions),
					reject
				)
				response = new Response2(body, responseOptions)
				resolve2(response)
					...
					body =
						(chunk[0] & 15) === 8
							? (0, import_node_stream2.pipeline)(
									body,
									import_node_zlib2.default.createInflate(),
									reject
							  )
							: (0, import_node_stream2.pipeline)(
									body,
									import_node_zlib2.default.createInflateRaw(),
									reject
							  )
					response = new Response2(body, responseOptions)
					resolve2(response)
			...
			if (codings === 'br') {
				body = (0, import_node_stream2.pipeline)(
					body,
					import_node_zlib2.default.createBrotliDecompress(),
					reject
				)
				response = new Response2(body, responseOptions)
				resolve2(response)
...
var init_install_fetch = __esm({
	'node_modules/@sveltejs/kit/dist/install-fetch.js'() {
		...
		;(function (module2, exports) {
			;(function (global2, factory) {
				...
				function WritableStreamAbort(stream, reason) {
					...
					;(_a4 = stream._writableStreamController._abortController) === null || _a4 === void 0
						? void 0
						: _a4.abort()
				...
				constructor(blobParts = [], options = {}) {
					...
					for (const element of blobParts) {
						...
						__privateSet(
							this,
							_size,
							__privateGet(this, _size) + (ArrayBuffer.isView(part) ? part.byteLength : part.size)
						)
		...
		validateHeaderName =
			typeof import_node_http2.default.validateHeaderName === 'function'
				? import_node_http2.default.validateHeaderName
				: (name) => {
						if (!/^[\^`\-\w!#$%&'*+.|~]+$/.test(name)) {
		...
		validateHeaderValue =
			typeof import_node_http2.default.validateHeaderValue === 'function'
				? import_node_http2.default.validateHeaderValue
				: (name, value) => {
						if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(value)) {
...
var init__ = __esm({
	'.svelte-kit/output/server/nodes/0.js'() {
		init_layout_svelte()
		entry = 'pages/__layout.svelte-219553e1.js'
		js = ['pages/__layout.svelte-219553e1.js', 'chunks/vendor-808be89d.js']
		css2 = ['assets/pages/__layout.svelte-bd9540de.css']
	}
})
...
var init__2 = __esm({
	'.svelte-kit/output/server/nodes/1.js'() {
		init_error_svelte()
		entry2 = 'error.svelte-760c9fad.js'
		js2 = ['error.svelte-760c9fad.js', 'chunks/vendor-808be89d.js']
		css3 = []
	}
})
...
var init_index_svelte = __esm({
	'.svelte-kit/output/server/entries/pages/index.svelte.js'() {
		...
		Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
			return `${
				(($$result.head += `${
					(($$result.title = `<title>\u041C\u0430\u043A\u0441\u0438\u043C \u0422\u0435\u0440\u0435\u0448\u043A\u043E</title>`),
					'')
				}`),
				'')
			}

<main class="${'p-8 text-xl'}"><h1 class="${'mb-8'}">\u041C\u0430\u043A\u0441\u0438\u043C \u0422\u0435\u0440\u0435\u0448\u043A\u043E \u26C4\uFE0F</h1>

	<ul><li class="${'mb-4'}"><a class="${'border-b-2 border-gray'}" href="${'https://t.me/xxtereshko'}" rel="${'noopener noreferrer'}">telegram</a></li>
		<li class="${'mb-4'}"><a class="${'border-b-2 border-gray'}" href="${'mailto:hey@tereshko.net'}" rel="${'noopener noreferrer'}">hey@tereshko.net</a></li></ul></main>`
		})
	}
})
...
var init__3 = __esm({
	'.svelte-kit/output/server/nodes/2.js'() {
		init_index_svelte()
		entry3 = 'pages/index.svelte-d8f5a6e5.js'
		js3 = ['pages/index.svelte-d8f5a6e5.js', 'chunks/vendor-808be89d.js']
		css4 = []
	}
})
...
async function render_response({
	...
	if (page_config.ssr) {
		branch.forEach(({ node, loaded, fetched, uses_credentials }) => {
			if (node.css) node.css.forEach((url2) => css22.add(url2))
			if (node.js) node.js.forEach((url2) => js4.add(url2))
							...
							async function text() {
								...
								if (!opts.body || typeof opts.body === 'string') {
									fetched.push({
										url: requested,
										body: opts.body,
										json: `{"status":${response2.status},"statusText":${s2(
											response2.statusText
										)},"headers":${s2(headers)},"body":"${escape_json_string_in_html(body)}"}`
									})
								}
								return body
							}
...
var ReadOnlyFormData = class {
	...
	*keys() {
		for (const [key] of __privateGet2(this, _map)) yield key
	}
	*values() {
				...
				for (const route of options.manifest._.routes) {
					...
					const response =
						route.type === 'endpoint'
							...
							: await render_page(request2, route, match, options, state)
					if (response) {
	...
	<head>
		...
		<style>
			@font-face {
				...
				font-display: swap;
				unicode-range: U+A, U+21-5A, U+5C, U+5E, U+5F, U+61-7A, U+7C, U+A9, U+AB, U+AE, U+BB, U+401,
					U+410-44F, U+451, U+2014, U+20BD;
			}
		</style>
		<meta name="description" content="\u041C\u0430\u043A\u0441\u0438\u043C \u0422\u0435\u0440\u0435\u0448\u043A\u043E" />
		<meta name="theme-color" content="#ffffff" />
		<link rel="icon" type="image/png" href="icons/favicon16w.png" sizes="16x16" />
		<link rel="icon" type="image/png" href="icons/favicon32w.png" sizes="32x32" />
		<link rel="apple-touch-icon" href="icons/favicon192w.png" />
...
var manifest = {
	...
	_: {
		...
		entry: {
			file: 'start-3dfdf8ba.js',
			js: ['start-3dfdf8ba.js', 'chunks/vendor-808be89d.js'],
			css: ['assets/start-d5b4de3e.css']
		},
		nodes: [
