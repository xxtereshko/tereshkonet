...
function W(t) {
	...
	for (let i = 0; i < n.length; i++) {
		const u = n[i].claim_order,
			a = (c > 0 && n[e[c]].claim_order <= u ? c + 1 : P(1, c, (x) => n[e[x]].claim_order, u)) - 1
		r[i] = e[a] + 1
		const f = a + 1
	...
	for (let i = e[c] + 1; i != 0; i = r[i - 1]) {
		for (s.push(n[i - 1]); l >= i; l--) o.push(n[l])
		l--
	}
	for (; l >= 0; l--) o.push(n[l])
	s.reverse(), o.sort((i, u) => i.claim_order - u.claim_order)
	for (let i = 0, u = 0; i < o.length; i++) {
		for (; u < s.length && o[i].claim_order >= s[u].claim_order; ) u++
		const a = u < s.length ? s[u] : null
		t.insertBefore(o[i], a)
	}
}
function K(t, n) {
	if (b) {
...
function ft(t, n, e) {
	b && !e ? K(t, n) : (n.parentNode !== t || n.nextSibling != e) && t.insertBefore(n, e || null)
}
function Q(t) {
...
function T(t, n, e, r, c = !1) {
	...
	const s = (() => {
		for (let o = t.claim_info.last_index; o < t.length; o++) {
			...
			if (n(l)) {
				const i = e(l)
				return i === void 0 ? t.splice(o, 1) : (t[o] = i), c || (t.claim_info.last_index = o), l
			}
		}
		for (let o = t.claim_info.last_index - 1; o >= 0; o--) {
			...
			if (n(l)) {
				const i = e(l)
				return (
					i === void 0 ? t.splice(o, 1) : (t[o] = i),
					c ? i === void 0 && t.claim_info.last_index-- : (t.claim_info.last_index = o),
					l
				)
			}
		}
...
function At(t, n) {
	...
	for (; s--; ) {
		const o = t[s],
			l = n[s]
		if (l) {
			for (const i in o) i in l || (r[i] = 1)
			for (const i in l) c[i] || ((e[i] = l[i]), (c[i] = 1))
			t[s] = l
		} else for (const i in o) c[i] = 1
	}
	for (const o in r) o in e || (e[o] = void 0)
	return e
}
function Et(t) {
...
function it(t, n, e, r) {
	...
	c && c.m(n, e),
		r ||
			j(() => {
				const i = s.map(M).filter(H)
				o ? o.push(...i) : m(i), (t.$$.on_mount = [])
			}),
		l.forEach(j)
}
function rt(t, n) {
...
function ct(t, n) {
	t.$$.dirty[0] === -1 && (g.push(t), tt(), t.$$.dirty.fill(0)),
		(t.$$.dirty[(n / 31) | 0] |= 1 << n % 31)
}
function Nt(t, n, e, r, c, s, o, l = [-1]) {
	const i = p
	y(t)
	const u = (t.$$ = {
		fragment: null,
	...
	if (
		...
		n.intro && et(t.$$.fragment), it(t, n.target, n.anchor, n.customElement), L(), D()
	}
	y(i)
}
class Ct {
...
function qt(t, n = h) {
	...
	function c(l) {
		if (I(t, l) && ((t = l), e)) {
			const i = !_.length
			for (const u of r) u[1](), _.push(u, t)
			if (i) {
